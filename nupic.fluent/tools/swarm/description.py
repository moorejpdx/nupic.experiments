...
config = {
    ...
    'modelParams': {
        ...
        'sensorParams': {
            ...
            #
            'encoders': {
                u'subject':     {   'fieldname': u'subject',
    'n': 121,
    'name': u'subject',
    'type': 'SDRCategoryEncoder',
    'w': 21},
  u'verb':     {   'fieldname': u'verb',
    'n': 121,
    'name': u'verb',
    'type': 'SDRCategoryEncoder',
    'w': 21},
  u'object':     {   'fieldname': u'object',
    'n': 121,
    'name': u'object',
    'type': 'SDRCategoryEncoder',
    'w': 21},
...
control = {
  ...
  'dataset' : {   u'info': u'foxeat',
        u'streams': [   {   u'columns': [u'*'],
                            u'info': u'Rec Center',
                            u'source': u'file://data/associations/swarm_foxeat.txt'}],
        u'version': 1},
 ...
 u'predictedField': u'object',
 u'predictionSteps': [1]},

  # Metrics: A list of MetricSpecs that instantiate the metrics that are
  # computed for this experiment
  'metrics':[
    MetricSpec(field=u'object', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 1000, 'steps': [1], 'errorMetric': 'avg_err'})
  ],

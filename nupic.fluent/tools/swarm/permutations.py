...
'/home/moorej/sandbox/nupic/nupic/build/release/lib/python2.7/site-packages/nupic/frameworks/opf/exp_generator/ExpGenerator.pyc'
"""
...
permutations = {
  ...
  'modelParams': {
    ...
    'sensorParams': {
      'encoders': {
          u'subject': PermuteEncoder(fieldName='subject', encoderClass='SDRCategoryEncoder', w=21, n=121, ),
  u'verb': PermuteEncoder(fieldName='verb', encoderClass='SDRCategoryEncoder', w=21, n=121, ),
  u'object': PermuteEncoder(fieldName='object', encoderClass='SDRCategoryEncoder', w=21, n=121, ),
  '_classifierInput': dict(classifierOnly=True, n=121, fieldname='object', w=21, type='SDRCategoryEncoder', ),
      },
    },
...
#       report generator
# (generated from minimize = "multiStepBestPredictions:multiStep:errorMetric='avg_err':steps=\[1\]:window=1000:field=object")
minimize = "multiStepBestPredictions:multiStep:errorMetric='avg_err':steps=\[1\]:window=1000:field=object"
